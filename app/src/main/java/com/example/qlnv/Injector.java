...
public class Injector {
    ...
    public static String URL_ADD_TIME_RECORER = "http://" + IP + ":8080/QLNS_V1/TimeRecorder/addTimeRecorder.php";
    public static String URL_UPDATE_TIME_RECORER = "http://" + IP + ":8080/QLNS_V1/TimeRecorder/editTimeRecorder.php";
    public static String URL_GET_TIME_RECORER = "http://" + IP + ":8080/QLNS_V1/TimeRecorder/getTimeRecorder.php";

    public static String URL_GET_CHAM_CONG_NV = "http://" + IP + ":8080/QLNS_V1/TimeRecorder/getChamCongNV.php";
    public static String URL_GET_CHAM_CONG_NV_ALL = "http://" + IP + ":8080/QLNS_V1/TimeRecorder/getChamCong.php";
    public static String URL_SEARCH_CHAM_CONG = "http://" + IP + ":8080/QLNS_V1/Search/searchChamCong.php";
